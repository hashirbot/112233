        ...
        try {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    Toast.makeText(this@BatteryEntryActivity, "Error during registration: ${e.message}", Toast.LENGTH_LONG).show()
                    binding.btnRegister.isEnabled = true
                    binding.btnRegister.text = "Register Battery"
                }
            }
        } catch (e: Exception) {
            Toast.makeText(this, "Error in registerBattery: ${e.message}", Toast.LENGTH_LONG).show()
        }
    }
